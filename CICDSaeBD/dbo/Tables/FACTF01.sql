...
GO
CREATE NONCLUSTERED INDEX [IDX_FACTF_PAGOS01]
    ON [dbo].[FACTF01]([CVE_DOC] ASC, [METODODEPAGO] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_CVEPEDI_STATUS_F01]
    ON [dbo].[FACTF01]([CVE_PEDI] ASC, [STATUS] ASC);
