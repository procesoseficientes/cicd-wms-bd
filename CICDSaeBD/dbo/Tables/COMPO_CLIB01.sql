...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Clave de ordenes', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'COMPO_CLIB01', @level2type = N'COLUMN', @level2name = N'CLAVE_DOC';
