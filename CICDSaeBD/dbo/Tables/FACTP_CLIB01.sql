...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Clave de pedidos', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FACTP_CLIB01', @level2type = N'COLUMN', @level2name = N'CLAVE_DOC';
