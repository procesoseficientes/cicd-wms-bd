CREATE TABLE [dbo].[FACTE_CLIB01] (
    ...
    CONSTRAINT [PK_FACTE_CLIB01] PRIMARY KEY CLUSTERED ([CLAVE_DOC] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Clave documento', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FACTE_CLIB01', @level2type = N'COLUMN', @level2name = N'CLAVE_DOC';
