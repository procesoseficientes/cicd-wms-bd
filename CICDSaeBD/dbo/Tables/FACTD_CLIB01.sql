CREATE TABLE [dbo].[FACTD_CLIB01] (
    ...
    CONSTRAINT [PK_FACTD_CLIB01] PRIMARY KEY CLUSTERED ([CLAVE_DOC] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Clave de devoluciones', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FACTD_CLIB01', @level2type = N'COLUMN', @level2name = N'CLAVE_DOC';
