...
-- Ejemplo de Ejecucion:
				EXEC [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER_SAE_PRUEBAS] @RECEPTION_DOCUMENT_HEADER = 56241 -- numeric


*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER19062021]
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SELECT TOP 1
                   ...
                   [D].[E_LTPD],
                   [D].[FACTCONV],
                   [D].UNITARIO_CON_DESCUENTO*d.QTY_CONFIRMED,
                   [D].[MINDIRECTO],
