...
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER08052021]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] [D]
            ...
            INNER JOIN [SAE70EMPRESA01].[dbo].[COMPO01] [CH]
                ON LTRIM(RTRIM([CH].[CVE_DOC])) COLLATE DATABASE_DEFAULT = [H].[DOC_ID] COLLATE DATABASE_DEFAULT
            INNER JOIN [SAE70EMPRESA01].[dbo].[PAR_COMPO01] [CD]
