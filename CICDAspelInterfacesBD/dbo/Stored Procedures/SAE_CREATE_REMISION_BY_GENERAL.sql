...
BEGIN
    ...
    BEGIN TRY
        ...
        INTO [#DETALLE]
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_TASK_LIST] [D] WITH (NOLOCK)
            INNER JOIN [OP_WMS_ALZA].[wms].[OP_WMS_PICKING_ERP_DOCUMENT] [H] WITH (NOLOCK)
        ...
        INTO [#ENCABEZADO]
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_PICKING_ERP_DOCUMENT] [H] WITH (NOLOCK)
