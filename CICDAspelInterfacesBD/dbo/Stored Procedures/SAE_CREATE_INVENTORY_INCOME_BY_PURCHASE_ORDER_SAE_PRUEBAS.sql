...
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER_SAE_PRUEBAS]
...
BEGIN
    ...
    BEGIN TRY
        ...
        INTO [#DETALLE]
        FROM [OP_WMS_ALZA_QA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] [D]
            INNER JOIN [OP_WMS_ALZA_QA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [H]
            ...
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[COMPO01] [CH]
                ON LTRIM(RTRIM([CH].[CVE_DOC])) COLLATE DATABASE_DEFAULT = [H].[DOC_ID] COLLATE DATABASE_DEFAULT
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_COMPO01] [CD]
        ...
        SELECT [H].[DOC_ID],
               ...
               [CH].[FORMAENVIO]
        INTO [#ENCABEZADO]
        FROM [OP_WMS_ALZA_QA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [H]
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[COMPO01] [CH]
        ...
        FROM [SAE70EMPRESA01PRUEBAS].[dbo].[PROV01] [P]
        ...
        FROM [SAE70EMPRESA01PRUEBAS].[dbo].[FOLIOSC01]
        ...
        UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[FOLIOSC01]
        SET [ULT_DOC] = (CASE
        ...
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[OBS_DOCC01]
        (
            [CVE_OBS],
            [STR_OBS]
        )
        ...
        BEGIN
            ...
            UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[PRVPROD01]
        ...
        UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[ACOMP01]
        ...
        -- ------------------------------------------------------------------------------------
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[COMPR01]
        (
            [TIP_DOC],
            [CVE_DOC],
            [CVE_CLPV],
        ...
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[COMPR_CLIB01]
        (
            [CLAVE_DOC],
            [CAMPLIB1],
            [CAMPLIB2],
        ...
        BEGIN
            ...
            UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_COMPO01]
            SET [PXR] = (CASE
            ...
            INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_COMPR01]
            (
                [CVE_DOC],
                [NUM_PAR],
                [CVE_ART],
            ...
            UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[COMPO01]
            ...
            SET [TIP_DOC_E] = @TIPO_DOCUMENTO_FOLIO,
                [ENLAZADO] = (CASE
                                  ...
                                  (
                                      SELECT SUM([P].[PXR])
                                      FROM [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_COMPO01] [P]
            ...
            INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[DOCTOSIGC01]
            (
                [TIP_DOC],
                [CVE_DOC],
                [ANT_SIG],
            ...
            INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_COMPR_CLIB01]
            (
                [CLAVE_DOC],
                [NUM_PART],
                [CAMPLIB1],
