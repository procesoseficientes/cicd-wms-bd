...
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_CREDIT_MEMO_SAE_PRUEBAS]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [OP_WMS_ALZA_QA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] [D]
            ...
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[FACTF01] [CH]
                ON LTRIM(RTRIM([CH].[CVE_DOC])) COLLATE DATABASE_DEFAULT = [H].[DOC_ID] COLLATE DATABASE_DEFAULT
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_FACTF01] [CD]
        ...
        FROM [OP_WMS_ALZA_QA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [H]
            ...
            INNER JOIN [SAE70EMPRESA01PRUEBAS].[dbo].[FACTF_CLIB01] [CL]
        ...
        FROM [SAE70EMPRESA01PRUEBAS].[dbo].[CLIE01] [P]
        ...
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[CUEN_DET01]
        (
            [CVE_CLIE],
            [REFER],
            [NUM_CARGO],
        ...
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[FACTD01]
        (
            [TIP_DOC],
            [CVE_DOC],
            [CVE_CLPV],
        ...
        INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[FACTD_CLIB01]
        (
            [CLAVE_DOC],
            [CAMPLIB1],
            [CAMPLIB2],
        ...
        BEGIN
            ...
            UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_FACTF01]
            SET [PXS] = (CASE
            ...
            INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_FACTD01]
            (
                [CVE_DOC],
                [NUM_PAR],
                [CVE_ART],
            ...
            UPDATE [SAE70EMPRESA01PRUEBAS].[dbo].[FACTF01]
            SET [TIP_DOC_E] = @TIPO_DOCUMENTO_FOLIO,
                [ENLAZADO] = (CASE
                                  WHEN
                                  (
                                      SELECT SUM([P].[PXS])
                                      FROM [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_FACTF01] [P]
            ...
            INSERT INTO [SAE70EMPRESA01PRUEBAS].[dbo].[PAR_FACTD_CLIB01]
            (
                [CLAVE_DOC],
                [NUM_PART]
            )
