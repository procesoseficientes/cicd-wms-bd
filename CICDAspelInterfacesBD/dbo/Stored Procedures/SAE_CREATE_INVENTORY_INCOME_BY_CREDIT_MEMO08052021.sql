...
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_CREDIT_MEMO08052021]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [H]
            ...
            INNER JOIN [$(CICDSaeBD)].[dbo].[FACTF_CLIB01] [CL]
        ...
        UPDATE [$(CICDSaeBD)].[dbo].[FOLIOSF01]
        SET [ULT_DOC] = (CASE
        ...
        FROM [$(CICDSaeBD)].[dbo].[TBLCONTROL01]
        WHERE [ID_TABLA] = @TABLA_DOCUMENTO_COMENTARIO;


        UPDATE [$(CICDSaeBD)].[dbo].[TBLCONTROL01]
        ...
        INSERT INTO [$(CICDSaeBD)].[dbo].[OBS_DOCF01]
        (
            [CVE_OBS],
            [STR_OBS]
        )
