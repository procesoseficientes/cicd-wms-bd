...
-- Ejemplo de Ejecucion:
				EXEC [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER] @RECEPTION_DOCUMENT_HEADER = 707 -- numeric
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_INVENTORY_INCOME_BY_PURCHASE_ORDER_SAE_PRUEBAS1]
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] [D]
            ...
            INNER JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[COMPO04] [CH]
                ON LTRIM(RTRIM([CH].[CVE_DOC])) COLLATE DATABASE_DEFAULT = [H].[DOC_ID] COLLATE DATABASE_DEFAULT
            INNER JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_COMPO04] [CD]
        ...
        FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[PROV04] [P]
        ...
        SELECT TOP (1)
               ...
               @DOCUMENTO_ERP_FORMATEADO = [dbo].[FUNC_ADD_CHARS]([dbo].[FUNC_ADD_CHARS]([ULT_DOC] + 1, '0', 10), ' ', 20)
        FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[FOLIOSC04]
        ...
        UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[FOLIOSC04]
        SET [ULT_DOC] = (CASE
        ...
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[OBS_DOCC04]
        (
            [CVE_OBS],
            [STR_OBS]
        )
        ...
        BEGIN
            SELECT TOP (1)
                   ...
                   @ORDEN_COMPRA_DOCUMENTO = [CVE_DOC],
                   @EXISTENCIAS = 0,
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[PRVPROD04]
        ...
        UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[ACOMP04]
        ...
        -- ------------------------------------------------------------------------------------
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[COMPR04]
        (
            [TIP_DOC],
            [CVE_DOC],
            [CVE_CLPV],
        ...
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[COMPR_CLIB04]
        (
            [CLAVE_DOC],
            [CAMPLIB1],
            [CAMPLIB2],
        ...
        BEGIN
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_COMPO04]
            SET [PXR] = (CASE
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_COMPR04]
            (
                [CVE_DOC],
                [NUM_PAR],
                [CVE_ART],
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[COMPO04]
            ...
            SET [TIP_DOC_E] = @TIPO_DOCUMENTO_FOLIO,
                [ENLAZADO] = (CASE
                                  ...
                                  (
                                      SELECT SUM([P].[PXR])
                                      FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_COMPO04] [P]
                                      WHERE [P].[CVE_DOC] = @ORDEN_COMPRA_DOCUMENTO
                                            AND [COMPO04].[CVE_DOC] = [P].[CVE_DOC]
                                  ) = 0 THEN
                                      'T'
                                  WHEN
                                  (
            ...
            WHERE [COMPO04].[CVE_DOC] = @ORDEN_COMPRA_DOCUMENTO;
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[DOCTOSIGC04]
            (
                [TIP_DOC],
                [CVE_DOC],
                [ANT_SIG],
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_COMPR_CLIB04]
            (
                [CLAVE_DOC],
                [NUM_PART],
                [CAMPLIB1],
