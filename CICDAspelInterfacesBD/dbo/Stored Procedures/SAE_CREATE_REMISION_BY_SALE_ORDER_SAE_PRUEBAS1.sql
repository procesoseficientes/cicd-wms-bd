...
*/
-- =============================================
CREATE PROCEDURE [dbo].[SAE_CREATE_REMISION_BY_SALE_ORDER_SAE_PRUEBAS1]
...
BEGIN
    ...
    DECLARE @TABLA_DOCUMENTO_32 INT = 32,
            ...
            @SERIE_FOLIO VARCHAR(10) = '000001-01-',
            @ULT_DOC_FOLIO INT,
    ...
    BEGIN TRY
        ...
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_NEXT_PICKING_DEMAND_DETAIL] [D]
            ...
            INNER JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_FACTP04] [DF]
        ...
        FROM [OP_WMS_ALZA].[wms].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [H]
            INNER JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[FACTP04] [FACT]
        ...
        SELECT TOP (1)
               ...
               @DOCUMENTO_ERP_FORMATEADO = [SERIE] + [dbo].[FUNC_ADD_CHARS]([ULT_DOC] + 1, '0', 10)
        FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[FOLIOSF04]
        ...
        UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[FOLIOSF04]
        SET [ULT_DOC] = (CASE
        ...
        SELECT TOP (1)
               @COMENTARIO
                   = 'Documento: ' + ISNULL(@DOCUMENTO_ERP_FORMATEADO, ' ') + ' Tarea Swift: '
        ...
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[OBS_DOCF04]
        (
            [CVE_OBS],
            [STR_OBS]
        )
        ...
        BEGIN
            ...
            (
                ...
                (
                    SELECT [INVE].[CVE_ART],
                           [MULT].[EXIST]
                    FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[INVE04] [INVE]
                        LEFT JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[MULT04] [MULT]
                            ON [INVE].[CVE_ART] = [MULT].[CVE_ART]
                    WHERE [MULT].[CVE_ALM] = 1
                          AND ([INVE].[CVE_ART] = @ERP_MATERIAL_CODE)
                    UNION ALL
                    SELECT [INVE].[CVE_ART],
                           [MULT].[EXIST]
                    FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[INVE04] [INVE]
                        LEFT JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[CVES_ALTER04] [CA]
                ...
                HAVING SUM([EXIST]) <
                (
                    SELECT SUM(@QTY_DETAIL) FROM [#DETALLE] WHERE [CVE_ART] = [CVE_ART]
                )
            )
            BEGIN
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[INVE04]
            SET [PEND_SURT] = (CASE
            ...
            SELECT TOP (1)
                   @TIPO_MOV = [TIPO_MOV],
                   @SIGNO = [SIGNO]
            FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[CONM04]
            ...
            FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[INVE04] [I]
                LEFT JOIN [SAE70EMPRESA01_PRUEBAS].[dbo].[MULT04] [M]
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[MINVE04]
            (
                [CVE_ART],
                [ALMACEN],
                [NUM_MOV],
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[MULT04]
            SET [EXIST] = [EXIST] + @QTY_DETAIL,
                [VERSION_SINC] = @FECHA_SYNC
            WHERE [CVE_ART] = @ERP_MATERIAL_CODE
                  AND [CVE_ALM] = @ALMACEN;
        ...
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[BITA04]
        (
            [CVE_BITA],
            [CVE_CAMPANIA],
            [STATUS],
        ...
        -- ------------------------------------------------------------------------------------
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[FACTR04]
        (
            [TIP_DOC],
            [CVE_DOC],
            [CVE_CLPV],
        ...
        INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[FACTR_CLIB04]
        (
            [CLAVE_DOC],
            [CAMPLIB1],
            [CAMPLIB2],
        ...
        BEGIN
            ...
            UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_FACTP04]
            SET [PXS] = (CASE
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_FACTR04]
            (
                [CVE_DOC],
                [NUM_PAR],
                [CVE_ART],
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[DOCTOSIGF04]
            (
                [TIP_DOC],
                [CVE_DOC],
                [ANT_SIG],
            ...
            INSERT INTO [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_FACTR_CLIB04]
            (
                [CLAVE_DOC],
                [NUM_PART]
            )
        ...
        -- ------------------------------------------------------------------------------------
        UPDATE [SAE70EMPRESA01_PRUEBAS].[dbo].[FACTP04]
        SET [TIP_DOC_E] = @TIPO_DOCUMENTO_FOLIO,
            ...
            [ENLAZADO] = (CASE
                              ...
                              (
                                  SELECT SUM([P].[PXS])
                                  FROM [SAE70EMPRESA01_PRUEBAS].[dbo].[PAR_FACTP04] [P]
                                  WHERE [P].[CVE_DOC] = @ORDEN_VENTA_DOCUMENTO
                                        AND [FACTP04].[CVE_DOC] = [P].[CVE_DOC]
                              ) = 0 THEN
                                  'T'
                              WHEN
                              (
        ...
        WHERE [FACTP04].[CVE_DOC] = @ORDEN_VENTA_DOCUMENTO;
