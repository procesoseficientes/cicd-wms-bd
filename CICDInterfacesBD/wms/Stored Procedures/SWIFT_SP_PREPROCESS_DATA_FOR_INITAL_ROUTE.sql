...
-- Ejemplo de Ejecucion:
			EXEC  [wms].[SWIFT_SP_PREPROCESS_DATA_FOR_INITAL_ROUTE]
*/
-- =============================================
CREATE PROCEDURE [wms].[SWIFT_SP_PREPROCESS_DATA_FOR_INITAL_ROUTE]
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  BEGIN TRY
    ...
    EXEC [SWIFT_EXPRESS].[wms].[SONDA_SP_GET_READY_TO_START_ROUTE] @CODE_ROUTE = @CODE_ROUTE
  ...
  BEGIN CATCH
    ...
    EXEC [SWIFT_EXPRESS].[wms].[SONDA_SP_INSERT_SONDA_SERVER_ERROR_LOG] @CODE_ROUTE = @CODE_ROUTE
                                                         ,@LOGIN = 'Preprocess'
