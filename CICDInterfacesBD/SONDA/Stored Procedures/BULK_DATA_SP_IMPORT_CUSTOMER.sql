...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SONDA].[BULK_DATA_SP_IMPORT_CUSTOMER]
*/
-- =============================================
...
BEGIN
  ...
  --
	...
	--SET [SELLER_DEFAULT_CODE]=NULL;

	MERGE [SONDA].[SWIFT_ERP_CUSTOMERS] [TRG]
	USING
		(SELECT
				*
			FROM
				[SWIFT_INTERFACES_ONLINE].[SONDA].[ERP_VIEW_COSTUMER])
		AS [SRC]
