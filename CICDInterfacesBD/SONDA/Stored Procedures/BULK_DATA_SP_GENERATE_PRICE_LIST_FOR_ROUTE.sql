...
-- Ejemplo de Ejecucion:
			EXEC [SONDA].[BULK_DATA_SP_GENERATE_PRICE_LIST_FOR_ROUTE]
*/
-- =============================================
...
BEGIN
  ...
  IF EXISTS (SELECT
        *
      FROM [SWIFT_EXPRESS].[SONDA].[SWIFT_PARAMETER] [SP]
  ...
  BEGIN
    ...
    -- ------------------------------------------------------------------------------------
    TRUNCATE TABLE [SWIFT_EXPRESS].[SONDA].[SWIFT_PRICE_LIST_BY_CUSTOMER_FOR_ROUTE]
    ...
    BEGIN
      ...
      EXEC [SWIFT_EXPRESS].[SONDA].[SWIFT_SP_GENERATE_PRICE_LIST_FOR_ROUTE] @CODE_ROUTE = @CODE_ROUTE
