...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SONDA].[BULK_DATA_SP_IMPORT_WAREHOUSE]
*/
-- =============================================
...
BEGIN
	SET NOCOUNT ON;
	--
	MERGE [SWIFT_EXPRESS].[SONDA].[SWIFT_WAREHOUSES] SW 
	USING ( SELECT * FROM  [SWIFT_INTERFACES_ONLINE].[SONDA].[ERP_VIEW_WAREHOUSE]) WVH 
