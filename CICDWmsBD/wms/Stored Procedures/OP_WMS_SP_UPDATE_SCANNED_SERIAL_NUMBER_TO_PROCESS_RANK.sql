...
-- Ejemplo de Ejecucion:
	EXEC [wms].[OP_WMS_SP_UPDATE_SCANNED_SERIAL_NUMBER_TO_PROCESS_RANK] @SERIAL_NUMBER = '201234567899'
                                                                    ,@LICENSE_ID = 167669
                                                                    ,@STATUS = 1
                                                                    ,@WAVE_PICKING_ID = 0
...
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_SP_UPDATE_SCANNED_SERIAL_NUMBER_TO_PROCESS_RANK] (
