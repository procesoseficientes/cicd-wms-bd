...
-- Ejemplo de Ejecucion:  
	EXEC [wms].OP_WMS_SP_GET_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER_BY_USER @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE wms.OP_WMS_SP_GET_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER_BY_USER (@LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
