...
EXEC [wms].[OP_WMS_SP_UPDATE_LICENSE_FAST_PICKING] @LOGIN_ID = '', -- varchar(50)
	@LICENSE_ID = 0, -- int
...
CREATE PROCEDURE [wms].[OP_WMS_SP_UPDATE_LICENSE_TOTAL_REALLOC_FAST_PICKING] (
		@LOGIN_ID VARCHAR(50)
		,@LICENSE_ID INT
		,@LOCATION_ID VARCHAR(25)
