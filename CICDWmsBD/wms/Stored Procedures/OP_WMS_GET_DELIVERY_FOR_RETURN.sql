...
-- Ejemplo de Ejecucion:
				EXEC [wms].[OP_WMS_GET_DELIVERY_FOR_RETURN] 
					@OWNER = 'Motorganica', -- varchar(50)
					@DOC_NUM = 12037276, -- int
					@EXTERNAL_SOURCE_ID = 4 -- int
						exec [wms].OP_WMS_GET_INVOICE_FOR_RETURN  @DOC_NUM=20055889,@OWNER=N'autovanguard',@EXTERNAL_SOURCE_ID=4
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_GET_DELIVERY_FOR_RETURN]
    (
     @OWNER VARCHAR(50)
    ,@DOC_NUM VARCHAR(50)
