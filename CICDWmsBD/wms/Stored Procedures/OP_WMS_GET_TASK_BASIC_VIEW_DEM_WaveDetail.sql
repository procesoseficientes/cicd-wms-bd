...
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_GET_TASK_BASIC_VIEW_DEM_WaveDetail] (
...
BEGIN
  ...
  -- ------------------------------------------------------------------------------------
	SELECT WAVE_PICKING_ID = ISNULL([R].[WAVE_PICKING_ID], REPLACE([R].[TASK_COMMENTS], 'TAREA DE RECEPCION NO. ', ''))
	FROM
		[#RESULT] [R]
