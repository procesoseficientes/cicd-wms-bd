...
-- Ejemplo de Ejecucion:
			EXEC [wms].[OP_WMS_SP_ALTER_REPLEANISH_TASK] @MATERIAL_ID = 'C00277/MILAN-16M'
                                                       ,@WAVE_PICKING_ID = 0
...
*/
-- =============================================
CREATE PROCEDURE wms.OP_WMS_SP_ALTER_REPLEANISH_TASK (@MATERIAL_ID VARCHAR(25)
...
BEGIN
  ...
  INNER JOIN [wms].[OP_WMS_ZONE_TO_REPLENISH_IN_ZONE] [ZR]
    ON [ZR].[ZONE_ID] = [Z].[ZONE_ID]
  INNER JOIN [wms].[OP_WMS_ZONE] [DZ]
  ...
  IF NOT EXISTS (SELECT
      TOP 1
        1
      FROM wms.[OP_WMS_VIEW_REALLOC_AVAILABLE_GENERAL]
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      INSERT INTO @LICENCIAS
        SELECT
         ...
         ,[RAG].[QTY]
         ,[RAG].[FECHA_DOCUMENTO]
        FROM wms.[OP_WMS_VIEW_REALLOC_AVAILABLE_GENERAL] [RAG]
    ...
    BEGIN
      ...
      INSERT INTO @LICENCIAS
        ...
        FROM wms.[OP_WMS_VIEW_REALLOC_AVAILABLE_GENERAL_BATCH] [RAGB]
        INNER JOIN [#ZONES_FOR_REALLOC] [ZFR]
    ...
    INSERT INTO wms.OP_WMS_TASK_LIST (WAVE_PICKING_ID,
    TASK_TYPE,
    TASK_SUBTYPE,
    TASK_OWNER,
    TASK_ASSIGNEDTO,
