...
-- Ejemplo de Ejecucion:
			EXEC  [wms].[[OP_WMS_SP_GET_TOP5_PICKING_DOCUMENT]] @OWNER = 'wms', @IS_INVOICE = 0
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_SP_GET_TOP5_PICKING_DOCUMENT]
    (
     @OWNER VARCHAR(50)
    ,@IS_INVOICE INT = 0
    )
...
BEGIN
  ...
  -- ------------------------------------------------------------------------------------
    ...
    SELECT
        @INTERNAL_SALE_COMPANIES = 'ALZAHN'
    FROM
