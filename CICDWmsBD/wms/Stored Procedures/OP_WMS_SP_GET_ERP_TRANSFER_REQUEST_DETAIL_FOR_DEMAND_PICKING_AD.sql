...
*/
-- =============================================
create PROCEDURE [wms].[OP_WMS_SP_GET_ERP_TRANSFER_REQUEST_DETAIL_FOR_DEMAND_PICKING_AD] (@XML XML)
AS
BEGIN
	SET NOCOUNT ON;
    --
	...
	BEGIN TRY
		...
		LEFT JOIN [wms].[OP_WMS_UNIT_MEASUREMENT_BY_MATERIAL] [UMM] ON [UMM].[MATERIAL_ID]  = [PDD].[SKU] 
