...
-- Ejemplo de Ejecucion:
         EXEC [wms].[OP_WMS_SP_GET_GENERAL_RECEPTION_DETAILS_SERIES_BY_SAP_R3] @RECEPTION_HEADER = 108
*/
CREATE PROCEDURE [wms].[OP_WMS_SP_GET_GENERAL_RECEPTION_DETAILS_SERIES_BY_SAP_R3] (
