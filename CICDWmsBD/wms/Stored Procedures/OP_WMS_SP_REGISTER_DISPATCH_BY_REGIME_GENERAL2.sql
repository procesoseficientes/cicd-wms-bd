...
--exec sp_executesql @statement=N'wms.OP_WMS_SP_REGISTER_DISPATCH_BY_REGIME_GENERAL2 @pLOGIN_ID = N''BGOMEZ'', @pCLIENT_OWNER = N''ALZA'', @pMATERIAL_ID = N''ALZA/12199'', @pMATERIAL_BARCODE = N''12199'', @pSOURCE_LICENSE = 646636, @pSOURCE_LOCATION = N''B04_REC'', @pQUANTITY_UNITS = 4,  @pCODIGO_POLIZA = N''547479'', @pWAVE_PICKING_ID = 80009, @pSERIAL_NUMBER = 809463, @pTipoUbicacion =N''RECEPCION'', @pMt2 = 0, @pRESULT = N'''', @pTASK_ID = 80009, @LICENSE_DISPATCH_ID = 646639'

CREATE PROCEDURE [wms].[OP_WMS_SP_REGISTER_DISPATCH_BY_REGIME_GENERAL2] (
