...
-- Ejemplo de Ejecucion:
			EXEC [wms].[OP_WMS_GET_SERVICE_TO_BILL_AUDIT_RECEPTION]  @INICIAL_DATE = '2016-11-03 00:00:00.000'
  , @END_DATE = '2016-11-03 23:59:59.850', @LAST_UPDATED_BY = 'PAGUILAR'
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_GET_SERVICE_TO_BILL_AUDIT_RECEPTION] (@INICIAL_DATE DATETIME
, @END_DATE DATETIME
...
--  AND @END_DATE <= [H].[VALID_TO]
  ...
  SELECT
   ...
   ,[C].[ACUERDO_COMERCIAL]
  FROM [wms].[OP_WMS_AUDIT_RECEPTION_CONTROL] ARC
