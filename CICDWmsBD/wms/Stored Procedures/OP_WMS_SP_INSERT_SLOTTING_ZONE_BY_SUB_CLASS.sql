...
-- Ejemplo de Ejecucion:
	EXECUTE [wms].[OP_WMS_SP_INSERT_SLOTTING_ZONE_BY_SUB_CLASS] @WAREHOUSE_CODE = 'BODEGA_07', -- varchar(25)
																@ZONE_ID = 70, -- int
...
*/
-- =============================================
CREATE PROCEDURE [wms].[OP_WMS_SP_INSERT_SLOTTING_ZONE_BY_SUB_CLASS]
(
