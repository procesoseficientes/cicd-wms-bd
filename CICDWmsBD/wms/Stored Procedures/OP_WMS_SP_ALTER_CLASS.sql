...
-- Ejemplo de Ejecucion:
				EXEC [wms].[OP_WMS_SP_ALTER_CLASS] @CLASS_NAME = 'Plasticos', -- varchar(50)
...
*/
-- =============================================
CREATE PROCEDURE wms.OP_WMS_SP_ALTER_CLASS (@CLASS_NAME VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    DECLARE @ID INT;
    --
    INSERT INTO [wms].[OP_WMS_CLASS] ([CLASS_NAME]
    , [CLASS_DESCRIPTION]
    , [CLASS_TYPE]
    , [CREATED_BY]
    , [CREATED_DATETIME]
