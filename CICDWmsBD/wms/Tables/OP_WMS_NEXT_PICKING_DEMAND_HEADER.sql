CREATE TABLE [wms].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] (
    ...
    CONSTRAINT [PK__tmp_ms_x__0B42C25B71434562] PRIMARY KEY CLUSTERED ([PICKING_DEMAND_HEADER_ID] ASC),
...
GO
GRANT SELECT
    ON OBJECT::[wms].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] TO [Uwms]
    AS [wms];


GO
CREATE NONCLUSTERED INDEX [IDX_OP_WMS_ALZANEXT_PICKINGERP]
    ON [wms].[OP_WMS_NEXT_PICKING_DEMAND_HEADER]([IS_FROM_ERP] ASC, [DEMAND_TYPE] ASC, [PICKING_DEMAND_HEADER_ID] ASC)
    INCLUDE([DOC_NUM]);
