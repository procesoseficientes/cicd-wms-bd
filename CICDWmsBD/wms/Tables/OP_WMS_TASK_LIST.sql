...
GO
CREATE NONCLUSTERED INDEX [TASLIST_TTYPE]
    ON [wms].[OP_WMS_TASK_LIST]([TASK_TYPE] ASC, [IS_CANCELED] ASC, [ASSIGNED_DATE] ASC)
    INCLUDE([WAVE_PICKING_ID], [LOCATION_SPOT_TARGET], [TRANSFER_REQUEST_ID]);


GO
CREATE NONCLUSTERED INDEX [TASKLIST_TASKTYPE]
    ON [wms].[OP_WMS_TASK_LIST]([TASK_TYPE] ASC)
    INCLUDE([WAVE_PICKING_ID], [TASK_SUBTYPE], [TASK_OWNER], [TASK_ASSIGNEDTO], [TASK_COMMENTS], [ASSIGNED_DATE], [QUANTITY_PENDING], [QUANTITY_ASSIGNED], [CODIGO_POLIZA_TARGET], [REGIMEN], [IS_COMPLETED], [IS_PAUSED], [IS_CANCELED], [WAREHOUSE_SOURCE], [LOCATION_SPOT_TARGET], [CLIENT_NAME], [ACCEPTED_DATE], [COMPLETED_DATE], [IS_DISCRETIONARY], [DOC_ID_SOURCE], [IS_ACCEPTED], [IS_FROM_SONDA], [IS_FROM_ERP], [PRIORITY], [PROJECT_ID], [PROJECT_CODE], [PROJECT_NAME], [PROJECT_SHORT_NAME], [ORDER_NUMBER]);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_TASK_LIST_ALL]
    ON [wms].[OP_WMS_TASK_LIST]([TASK_TYPE] ASC)
    INCLUDE([WAVE_PICKING_ID], [TASK_SUBTYPE], [TASK_OWNER], [TASK_ASSIGNEDTO], [TASK_COMMENTS], [ASSIGNED_DATE], [QUANTITY_PENDING], [QUANTITY_ASSIGNED], [CODIGO_POLIZA_TARGET], [REGIMEN], [IS_COMPLETED], [IS_PAUSED], [IS_CANCELED], [MATERIAL_ID], [BARCODE_ID], [MATERIAL_NAME], [LOCATION_SPOT_TARGET], [CLIENT_OWNER], [CLIENT_NAME], [ACCEPTED_DATE], [COMPLETED_DATE], [IS_DISCRETIONARY], [DOC_ID_SOURCE], [IS_ACCEPTED], [IS_FROM_SONDA], [IS_FROM_ERP], [PRIORITY], [PROJECT_ID], [PROJECT_CODE], [PROJECT_NAME], [PROJECT_SHORT_NAME], [ORDER_NUMBER]);


GO
CREATE NONCLUSTERED INDEX [IDX_TASKLWAVE]
    ON [wms].[OP_WMS_TASK_LIST]([TASK_SUBTYPE] ASC)
    INCLUDE([WAVE_PICKING_ID], [TASK_TYPE], [TASK_ASSIGNEDTO], [TASK_COMMENTS], [ASSIGNED_DATE], [QUANTITY_PENDING], [QUANTITY_ASSIGNED], [CODIGO_POLIZA_TARGET], [REGIMEN], [IS_COMPLETED], [IS_PAUSED], [IS_CANCELED], [MATERIAL_ID], [BARCODE_ID], [MATERIAL_NAME], [LOCATION_SPOT_TARGET], [CLIENT_OWNER], [CLIENT_NAME], [ACCEPTED_DATE], [COMPLETED_DATE], [IS_DISCRETIONARY], [IS_ACCEPTED], [IS_FROM_SONDA], [IS_FROM_ERP], [PROJECT_ID], [PROJECT_CODE], [PROJECT_NAME], [PROJECT_SHORT_NAME], [ORDER_NUMBER]);


GO
CREATE NONCLUSTERED INDEX [IDX_OP_WMS_ALZATASKTYPE]
    ON [wms].[OP_WMS_TASK_LIST]([TASK_TYPE] ASC)
    INCLUDE([WAVE_PICKING_ID], [TASK_SUBTYPE], [TASK_ASSIGNEDTO], [TASK_COMMENTS], [ASSIGNED_DATE], [CODIGO_POLIZA_TARGET], [REGIMEN], [IS_CANCELED], [MATERIAL_ID], [BARCODE_ID], [MATERIAL_NAME], [WAREHOUSE_SOURCE], [LOCATION_SPOT_TARGET], [CLIENT_OWNER], [CLIENT_NAME], [ACCEPTED_DATE], [COMPLETED_DATE], [IS_DISCRETIONARY], [IS_ACCEPTED], [IS_FROM_SONDA], [IS_FROM_ERP], [PROJECT_ID], [PROJECT_CODE], [PROJECT_NAME], [PROJECT_SHORT_NAME], [ORDER_NUMBER]);
