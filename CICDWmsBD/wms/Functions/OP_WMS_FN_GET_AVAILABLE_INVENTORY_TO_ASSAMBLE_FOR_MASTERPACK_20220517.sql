...
*/
-- =============================================
CREATE FUNCTION [wms].[OP_WMS_FN_GET_AVAILABLE_INVENTORY_TO_ASSAMBLE_FOR_MASTERPACK_20220517]
(
...
BEGIN
	...
	BEGIN
		...
		SET REAL_QTY = CAST([wms].[OP_WMS_FN_GET_AVAILABLE_INVENTORY_TO_ASSAMBLE_FOR_MASTERPACK](@SubComponentMaterial, @WAREHOUSE_ID) / @SubComponentQTY_NEEDED AS INT)
