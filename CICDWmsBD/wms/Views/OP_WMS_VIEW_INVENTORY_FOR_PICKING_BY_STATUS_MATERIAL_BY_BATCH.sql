...
-- Ejemplo de Ejecucion:
			SELECT  * FROM [wms].[OP_WMS_VIEW_INVENTORY_FOR_PICKING_BY_STATUS_MATERIAL_BY_BATCH]  
*/
-- =============================================
CREATE VIEW [wms].[OP_WMS_VIEW_INVENTORY_FOR_PICKING_BY_STATUS_MATERIAL_BY_BATCH]
AS
SELECT
	[M].[MATERIAL_ID]
	,[M].[MATERIAL_NAME]
