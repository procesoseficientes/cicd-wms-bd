...
*/
-- =============================================
ALTER VIEW [wms].[OP_WMS_VIEW_LOCATION_TO_REPLENISH]
AS
SELECT
	[MS].[LOCATION_SPOT]
	,[MS].[MATERIAL_ID]
...
WHERE
	...
	and ms.MATERIAL_ID not in (
		SELECT CBM1.MASTER_PACK_CODE FROM WMS.OP_WMS_COMPONENTS_BY_MASTER_PACK CBM1
